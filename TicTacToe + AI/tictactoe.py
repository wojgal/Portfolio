...
class TicTacToe:
    def __init__(self) -> None:
        ...
        self.button_1v1.switch_active()
        self.button_ai = Button(650, 150, AI_BUTTON_IMAGE, AI_PRESSED_BUTTON_IMAGE)
        self.button_restart = Button(650, 400, RESTART_IMAGE, RESTART_IMAGE)
        self.buttons = [self.button_1v1, self.button_ai, self.button_restart]
    ...
    def change_current_move(self) -> None:
    ...
    def get_ai_move(self) -> int:
        ...
        for idx in range(9):
            if board[idx] == 'None':
                board[idx] = 'o'
                evaluation = self.minimax(board, 0, False, 8)
                board[idx] = 'None'
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if self.gamemode == 'ai':
                        ...
                        if self.current_move == 'o':
                            pygame.time.set_timer(AI_MOVE_EVENT, 2000, 1)
                ...
                if event == AI_MOVE_EVENT:
                    if self.current_move == 'o':
                        ...
                        ai_field.set_type(self.current_move)
                        self.current_move = 'x'
                        pygame.event.post(CHECK_WIN_EVENT)
                        DRAW_SOUND.play()
